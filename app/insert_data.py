...
def insert_stic(database):
    ...
    for file in input_files:
        ...
        if not exists_in_database :
            if args.verbose:
                print("Parsing:", file)
                input("[verbose on] Press Enter to insert sample data.")
            ######################
            ...
            if args.verbose:
                input("[verbose on] Press Enter to insert ontology data.")
            #######################
            ...
            if args.verbose:
                input("[verbose on] Press Enter to insert clinical data.")
            #######################
            ...
            if args.verbose:
                input("[verbose on] Press Enter to insert variant data.")
            #######################
            ...
            if args.verbose:
                input("[verbose on] Press Enter to insert analysis data.")
            #######################
