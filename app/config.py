...
# Variants lists
VARIANTLIST_RANDA = USERPATH + 'MMDB_RAWDATA/' + 'variant_lists/' + 'Liste_Mitomap_randasendess.xls'
VARIANTLIST_ALICE = USERPATH + 'MMDB_RAWDATA/' + 'variant_lists/' + 'notesalicechoury_variants_list.txt'

# Reference
MTREFERENCE = USERPATH + 'MMDB_RAWDATA/' + 'reference/' + 'NC_012920.1.fasta'
